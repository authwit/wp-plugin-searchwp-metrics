<template>
	...
	<div class="searchwp-metrics wrap">
		...
		<div class="searchwp-metrics__title">
            ...
            <li>
              <button
                  class="searchwp-metrics-nonbutton"
                  v-close-popover
                  @click.prevent="showingClearMetricsDataBefore = true"
              >
                {{ i18n.clearMetricsDataBefore }}
              </button>
            </li>
      ...
      <vue-modaltor
          :visible="showingClearMetricsDataBefore"
          @hide="hideClearMetricsDataBefore"
          :default-width="'300px'">
        <div class="searchwp-metrics__modal searchwp-metrics__modal-confirmation">
          <h4><span class="dashicons dashicons-arrow-right"></span> {{ i18n.areYouSure }} <span class="dashicons dashicons-arrow-left"></span></h4>
          <component :is="translatedClearMetricsDataBeforeNote"></component>
          <div>
            <vue-datepicker-local
                v-model="clearMetricsDataBeforeDate"
          ...
          <ul class="searchwp-metrics__modal-confirmation--actions">
            <li>
              <button @click.prevent="clearMetricsDataBefore" class="button">
                {{ i18n.clearData }}
              </button>
            </li>
            <li>
              <button @click.prevent="hideClearMetricsDataBefore" class="searchwp-metrics-nonbutton">
                {{ i18n.cancel }}
              </button>
            </li>
          </ul>
				...
				<div class="searchwp-metrics__control-queries">
					...
					<vue-modaltor
						...
						<div class="searchwp-metrics__modal searchwp-metrics__ignored-searches-details">
							...
							<p><button class="button" @click="addNewIgnoredSearch">Add</button></p>
